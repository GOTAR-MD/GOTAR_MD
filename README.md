...
This configuration sets up your bot's behavior, such as auto-reading statuses, blocking calls, and defining the owner's contact information.

---

⚙️ GitHub Actions Workflow (`.github/workflows/deploy.yml`)

Create a directory `.github/workflows` in your project if it doesn't exist, and inside it, create a file named `deploy.yml` with the following content:
